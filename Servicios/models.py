...
class Producto(models.Model):
    ...
    rut_proveedor = models.ForeignKey(Proveedor, on_delete=models.CASCADE, db_column='rut_proveedor')
...
class DetalleOrdenPedido(models.Model):
    ...
    id_orden_pedido = models.ForeignKey(OrdenPedido, on_delete=models.CASCADE, db_column='id_orden_pedido')
...
class Platos(models.Model):
    ...
    id_servicio = models.ForeignKey(ServiciosComedor, on_delete=models.CASCADE, db_column='id_servicio')
